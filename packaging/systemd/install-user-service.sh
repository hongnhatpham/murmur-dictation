...
Installed:
  ...
  $service_dir/murmur.service          # future long-running daemon template
...
Do not enable murmur.service until the CLI exposes a long-running service/daemon subcommand.
MSG
