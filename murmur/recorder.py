...
def record(duration: float = 5.0, output: Path | None = None) -> Recording:
    ...
    cmd = ["timeout", "--signal=INT", str(duration), "pw-record", "--format=s16", "--rate=16000", "--channels=1", str(output)]
