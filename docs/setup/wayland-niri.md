...
intentional Murmur-specific override; remove it to follow the desktop input
selector again. The evdev hotkey service does not need its own source setting.
